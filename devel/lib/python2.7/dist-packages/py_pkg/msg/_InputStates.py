...
"""autogenerated by genpy from py_pkg/InputStates.msg. Do not edit."""
import sys
...
class InputStates(genpy.Message):
  _md5sum = "563b27884d008b0d2adff54dc1f9e4f5"
  _type = "py_pkg/InputStates"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InputStates, self).__init__(*args, **kwds)
